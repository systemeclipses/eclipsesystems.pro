...
import { activities, companies, contacts, deals, products, seedData, users, type Activity, type Company, type Contact, type Deal, type DealStage, type LineItem } from "@/lib/crm-demo-data";
